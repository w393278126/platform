...
#pragma warning disable 1573, 1591 // xml comments
    ...
    public static class SqlMapperExtensions
    {
        ...
        private static readonly ConcurrentDictionary<RuntimeTypeHandle, ICollection<PropertyInfo>> KeyProperties = new ConcurrentDictionary<RuntimeTypeHandle, ICollection<PropertyInfo>>();
        private static readonly ConcurrentDictionary<RuntimeTypeHandle, ICollection<PropertyInfo>> TypeProperties = new ConcurrentDictionary<RuntimeTypeHandle, ICollection<PropertyInfo>>();
        private static readonly ConcurrentDictionary<RuntimeTypeHandle, ICollection<PropertyInfo>> ComputedProperties = new ConcurrentDictionary<RuntimeTypeHandle, ICollection<PropertyInfo>>();
        private static readonly ConcurrentDictionary<RuntimeTypeHandle, string> GetQueries = new ConcurrentDictionary<RuntimeTypeHandle, string>();
        private static readonly ConcurrentDictionary<RuntimeTypeHandle, string> TypeTableName = new ConcurrentDictionary<RuntimeTypeHandle, string>();

        internal static readonly ConcurrentDictionary<RuntimeTypeHandle, string> SelectQueries = new ConcurrentDictionary<RuntimeTypeHandle, string>();
        ...
        internal static ICollection<PropertyInfo> ComputedPropertiesCache(Type type)
        {
            ICollection<PropertyInfo> pi;
        ...
        internal static ICollection<PropertyInfo> KeyPropertiesCache(Type type)
        {
            ...
            foreach (var property in allProperties)
            {
                ...
                {
                    if (attribute.ToString().IndexOf("KeyAttribute", StringComparison.OrdinalIgnoreCase) >-1)
                    {
        ...
        internal static ICollection<PropertyInfo> TypePropertiesCache(Type type)
        {
            ICollection<PropertyInfo> pis;
        ...
        internal static bool ExcludeStatus(PropertyInfo pi)
        {
            object[] attributes = pi.GetCustomAttributes(typeof(ExcludeStatusAttribute), false);
            if (attributes.Length == 1)
            {
                return true;
            }
