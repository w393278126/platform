...
namespace Xn.Platform.Infrastructure.Web
{
    ...
    public static class HttpHelper
    {
        ...
        private static String PreparePOSTForm(string url, IDictionary<string, string> data)
        {
            ...
            {
                strForm.Append("<input type=\"hidden\" name=\"" + parameter.Key + "\" value=\"" + parameter.Value + "\">");
            }
            strForm.Append("</form>");
        ...
        /// <Author>Samer Abu Rabie</Author>
        public static void RedirectAndPOST(Page page, string destinationUrl, IDictionary<string, string> data)
        {
