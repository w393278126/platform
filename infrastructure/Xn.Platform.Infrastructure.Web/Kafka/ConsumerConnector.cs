...
namespace Xn.Platform.Infrastructure.Web.Kafka
{
    public interface IConsumerConnector : IDisposable
    {
        ...
        IDictionary<string, IList<IKafkaMessageStream<KafkaMessage>>> CreateMessageStreams(
            IDictionary<string, int> topicThreadCount,
            IDecoder<KafkaMessage> decoder
            );
    ...
    internal class ConsumerConnector : IConsumerConnector
    {
        ...
        public IDictionary<string, IList<IKafkaMessageStream<KafkaMessage>>> CreateMessageStreams(IDictionary<string, int> topicThreadCount, IDecoder<KafkaMessage> decoder)
        {
